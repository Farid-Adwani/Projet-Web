...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=compteclub::class, inversedBy="users")
     */
    private $clubs;
    ...
    public function addClub(compteclub $club): self
    {
    ...
    public function removeClub(compteclub $club): self
    {
