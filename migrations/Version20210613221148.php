 ...
 */
final class Version20210613221148 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user CHANGE twitter twitter VARCHAR(255) DEFAULT \'www.twitter.com\' NOT NULL, CHANGE instagram instagram VARCHAR(255) DEFAULT \'www.twitter.com\' NOT NULL, CHANGE facebook facebook VARCHAR(255) DEFAULT NULL, CHANGE class class VARCHAR(255) DEFAULT NULL, CHANGE description description VARCHAR(255) DEFAULT NULL, CHANGE role role VARCHAR(255) DEFAULT NULL, CHANGE image image VARCHAR(255) DEFAULT NULL');
    }
